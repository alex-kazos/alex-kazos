...
👨‍💻 **Developer** | 🤖 **AI Specialist** | 🧑‍🎓 **Student**

I'm a developer with a business background, focused on building data-centric software systems, AI-powered tools, and full-stack applications. Currently, I'm doing my master's in Development & Cybersecurity while also learning about software design. 

My main interests are AI systems, data engineering, software design, automation, and building products **end-to-end** — from the database and backend to the frontend and deployment.
...
I also work on various projects, i.e. my site, machine learning, computer vision and process orchestration
